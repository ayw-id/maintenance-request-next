  ...
  return (
    <main className="flex flex-col w-6/12 gap-10 items-center">
      ...
      <div className="fixed bottom-4 right-4">
        <button onClick={showRequestForm} data-test="add-item" className="inline-flex items-center justify-center w-12 h-12 mr-2 text-white transition-colors duration-150 bg-[#36A388] rounded-full focus:shadow-outline hover:bg-pink-800">
